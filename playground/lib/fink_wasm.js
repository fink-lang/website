...
export class ParsedDocument {
     ...
     * @returns {Uint32Array}
     */
    get_definition(line, col) {
        const ret = wasm.parseddocument_get_definition(this.__wbg_ptr, line, col);
    ...
    get_diagnostics() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.parseddocument_get_diagnostics(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     * @returns {Uint32Array}
     */
    get_references(line, col) {
        const ret = wasm.parseddocument_get_references(this.__wbg_ptr, line, col);
        var v1 = getArrayU32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
     ...
     */
    get_semantic_tokens() {
        const ret = wasm.parseddocument_get_semantic_tokens(this.__wbg_ptr);
        var v1 = getArrayU32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
    ...
    constructor(src) {
        ...
        const ret = wasm.parseddocument_new(ptr0, len0);
        this.__wbg_ptr = ret >>> 0;
        ParsedDocumentFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('fink_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
